...
[@bs.get]
external rtcpTransport: t => PWA_RTCDtlsTransport.t = "rtcpTransport";

[@bs.get] external transport: t => PWA_RTCDtlsTransport.t = "transport";

[@bs.send]
external getContributingSources:
  t =>
  array({
    .
    "audioLevel": float,
...
[@bs.get]
external getSynchronizationSources:
  t => array({. "voiceActivityFlag": Js.Nullable.t(bool)}) =
